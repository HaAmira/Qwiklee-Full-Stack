  ...
  return (
    <section className='bg-neutral-900 fixed top-0 bottom-0 right-0 left-0 bg-opacity-70 z-50'>
        <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
            <div style={{backgroundColor: "rgb(0 121 107 / 90%)"}} className='flex items-center p-4 shadow-md gap-3 justify-between'>
            ...
            <div style={{backgroundColor: "rgb(148 163 184 / 9%)"}} className='min-h-[75vh] lg:min-h-[80vh] h-full max-h-[calc(100vh-150px)] p-2 flex flex-col gap-4'>
                {/***display items */}
                {
                    cartItem[0] ? (
                        <>
