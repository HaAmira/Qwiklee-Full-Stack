...
const Address = () => {
  ...
  return (
    <div className=''>
        <div style={{backgroundColor: "rgb(0 121 107 / 90%)"}} className='shadow-lg px-2 py-2 flex justify-between gap-4 items-center '>
        ...
        <div style={{backgroundColor: "rgb(148 163 184 / 9%)"}} className='p-2 grid gap-4'>
              {
